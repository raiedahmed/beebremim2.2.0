...
class _CirillaButtonSocialFacebook extends CirillaButtonSocial {
  ...
  Widget build(BuildContext context) {
    return buildContainer(
      context,
      size: size,
      color: ColorBlock.facebook,
      onPressed: onPressed,
      boxFit: boxFit,
      type: type,
      icon: buildIcon(icon: icon, color: ColorBlock.facebook, size: sizeIcon, boxFit: boxFit),
    );
  }
}
...
class _CirillaButtonSocialGoogle extends CirillaButtonSocial {
  ...
  Widget build(BuildContext context) {
    return buildContainer(
      ...
      boxFit: boxFit,
      type: type,
      icon: buildIcon(icon: icon, color: ColorBlock.google, size: sizeIcon, boxFit: boxFit),
    );
  }
}
...
class _CirillaButtonSocialSms extends CirillaButtonSocial {
  ...
  Widget build(BuildContext context) {
    return buildContainer(
      context,
      size: size,
      color: ColorBlock.sms,
      onPressed: onPressed,
      boxFit: boxFit,
      type: type,
      icon: buildIcon(icon: icon, color: ColorBlock.sms, size: sizeIcon, boxFit: boxFit),
    );
  }
}
...
class _CirillaButtonSocialTwitter extends CirillaButtonSocial {
  ...
  Widget build(BuildContext context) {
    return buildContainer(
      context,
      size: size,
      color: ColorBlock.twitter,
      onPressed: onPressed,
      boxFit: boxFit,
      type: type,
      icon: buildIcon(icon: icon, color: ColorBlock.twitter, size: sizeIcon, boxFit: boxFit),
    );
  }
}
...
class _CirillaButtonSocialPinterest extends CirillaButtonSocial {
  ...
  Widget build(BuildContext context) {
    return buildContainer(
      context,
      size: size,
      color: ColorBlock.pinterest,
      onPressed: onPressed,
      boxFit: boxFit,
      type: type,
      icon: buildIcon(icon: icon, color: ColorBlock.pinterest, size: sizeIcon, boxFit: boxFit),
    );
  }
}
...
class _CirillaButtonSocialLinkedIn extends CirillaButtonSocial {
  ...
  Widget build(BuildContext context) {
    return buildContainer(
      context,
      size: size,
      color: ColorBlock.linkedIn,
      onPressed: onPressed,
      boxFit: boxFit,
      type: type,
      icon: buildIcon(icon: icon, color: ColorBlock.linkedIn, size: sizeIcon, boxFit: boxFit),
    );
  }
}
...
class _CirillaButtonSocialYouTube extends CirillaButtonSocial {
  ...
  Widget build(BuildContext context) {
    return buildContainer(
      context,
      size: size,
      color: ColorBlock.youtube,
      onPressed: onPressed,
      boxFit: boxFit,
      type: type,
      icon: buildIcon(icon: icon, color: ColorBlock.youtube, size: sizeIcon, boxFit: boxFit),
    );
  }
}
...
class _CirillaButtonSocialInstagram extends CirillaButtonSocial {
  ...
  Widget build(BuildContext context) {
    return buildContainer(
      context,
      size: size,
      color: ColorBlock.instagram,
      onPressed: onPressed,
      boxFit: boxFit,
      type: type,
      icon: buildIcon(icon: icon, color: ColorBlock.instagram, size: sizeIcon, boxFit: boxFit),
    );
  }
}
...
class _CirillaButtonSocialSnapchat extends CirillaButtonSocial {
  ...
  Widget build(BuildContext context) {
    return buildContainer(
      context,
      size: size,
      color: ColorBlock.snapChat,
      onPressed: onPressed,
      boxFit: boxFit,
      type: type,
      icon: buildIcon(icon: icon, color: ColorBlock.snapChat, size: sizeIcon, boxFit: boxFit),
    );
  }
}
